<main common faq>
    ...
    <section id="faq">
        <div class="contain">
            ...
            <a href="<?= get_site_image_src("images/", $site_content['image1']) ?>" class="vidBlk imgBlk" data-fancybox="faq" data-aos="fade-up" data-aos-duration="1000">
                <img src="<?= get_site_image_src("images/", $site_content['image1']) ?>">
            </a>
            <div class="faqBox" data-aos="fade-down" data-aos-duration="1000">
                <div class="faqLst">
                    <?php
                    if (!empty($faqs)) {
                        foreach ($faqs as $faq) {
