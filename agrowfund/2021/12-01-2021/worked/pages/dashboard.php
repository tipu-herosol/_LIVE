<main dash>
    ...
    <section id="dash">
        <div class="contain-fluid">
            <div class="profBlk" data-aos="fade" data-aos-duration="1000">
            ...
            <div class="cardRow flex" data-aos="fade" data-aos-duration="1000">
                <div class="col">
                    <div class="tileBlk">
                        <div class="top">
                            <div class="txt">
            ...
            <div class="bnrRow flex" data-aos="fade" data-aos-duration="1000">
                <?php for ($i = 1; $i <= 3; $i++) : ?>
                    <div class="col">
            ...
            <h4 class="subheading" data-aos="fade" data-aos-duration="1000">Projets en cours</h4>
            <div class="flexRow flex" data-aos="fade" data-aos-duration="1000">
                <?php
