                    ...
                    <div class="logBlk">
                        <div class="formRow row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="txtGrp">
                                    <input type="text" name="email" id="" class="txtBox" placeholder="<?= $site_content['email_placeholder'] ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h6><?= $site_content['password_heading'] ?></h6>
                                <div class="txtGrp pasDv">
                                    <input type="password" name="password" id="" class="txtBox" placeholder="<?= $site_content['password_placeholder'] ?>" required>
