...
<body data-page="index">
    ...
    <main>
        ...
        <section id="banner" style="background-image: url('<?= getImageSrc('uploads/images/' . $row->image1) ?>');">
            ...
            <div class="contain">
                <div class="flex_blk">
                    <div class="content">
                        ...
                        <div class="btn_blk">
                            <h3>Coming soon</h3>
                            <!-- <a href="<?= empty($site_settings->header_btn_link) ? '' : $site_settings->header_btn_link ?>" class="site_btn md round"><?= empty($site_settings->header_btn_text) ? '' : $site_settings->header_btn_text ?></a> -->
                        </div>
                        <!-- <ul class="play_store">
                ...
                <div class="flex_row center">
                    <div class="col">
                        <div class="inner">
                            ...
                            <div class="txt" style="padding-left: 2.9rem;">
                    ...
                    <div class="col">
                        <div class="inner">
                            ...
                            <div class="txt" style="padding-left: 2.9rem;">
                                ...
                                <p><?= empty($row->sec4_middle_desc) ? '' : $row->sec4_middle_desc ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
        ...
        <section id="ready">
            <div class="contain text-center">
                <div class="inner">
                    <h2 class="heading"><?= empty($row->sec7_main_heading) ? '' : $row->sec7_main_heading ?></h2>
                    ...
                    <div class="br"></div> -->
                    <h5><?= empty($row->sec7_heading) ? '' : $row->sec7_heading ?></h5>
                    <!-- <ul class="play_store">
