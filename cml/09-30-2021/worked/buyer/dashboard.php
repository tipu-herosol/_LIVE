                                ...
                                <div class="formBlkOut">
                                    ...
                                    <div class="formBlk">
                                        ...
                                        <div class="row formRow">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 col-xx-6">
                                    ...
                                    <div class="formBlk">
                                        ...
                                        <div class="hotel-address-main txtGrp">
                                            ...
                                            <div class="row formRow">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-xx-12">
                    ...
                    <form action="<?= base_url() ?>index/change_password" method="post" id="changePassword" class="frmAjax">
                        ...
                        <div class="inside">
                            ...
                            <div class="row formRow">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-xx-12">
