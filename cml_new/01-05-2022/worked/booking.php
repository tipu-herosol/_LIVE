                                            ...
                                            <table class="sumryTblLst">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th class="price color text-center" id="estimated-total-preview">£<?= price_format($estimated_total + (price_format($estimated_total) > price_format($vendor->mem_charges_free_over) ? 0 : $pickup)) ?></th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
