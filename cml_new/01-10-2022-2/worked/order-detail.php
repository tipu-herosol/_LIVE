                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="form_blk">
                                                ...
                                                <!-- <div class="img_proof_row flex">
                                                    <div class="img">
                                                        <figure>
                                                            <img src="<?= base_url() ?>assets/images/b_01.jpg" alt="" data-src="" id="">
                                                            <button type="button" class="x_btn"></button>
                                                        </figure>
                                                    </div>
                                                    <div class="img">
                                                        <figure>
                                                            <img src="<?= base_url() ?>assets/images/b_02.jpg" alt="" data-src="" id="">
                                                            <button type="button" class="x_btn"></button>
                                                        </figure>
                                                    </div>
                                                    <div class="img">
                                                        <figure>
                                                            <img src="<?= base_url() ?>assets/images/b_03.jpg" alt="" data-src="" id="">
                                                            <button type="button" class="x_btn"></button>
                                                        </figure>
                                                    </div>
                                                </div> -->
            ...
            $(function() {
                $(document).on('click', '#add-amendment-row', function(e) {
                    ...
                    let html = `<div class="col-xs-12" id="row-${rowIndex}">
                                    ...
                                    <div class="btn_blk mt text-right">
                                        <button type="button" class="site_btn text danger">Delete</button>
                                    </div>
                                </div>`;
