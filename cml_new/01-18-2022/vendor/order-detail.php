                        ...
                        <div class="txt">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    ...
                                    <span>
                                        <textarea name="customer_notes" id="customer_notes" class="text_box form_blk" placeholder="Type Notes" <?=($order->order_status != 'Cancelled' && $order->order_status != 'Completed') ? '' : 'disabled' ?>><?= $order->order_note ?></textarea>
