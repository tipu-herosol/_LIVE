                                ...
                                <fieldset>
                                    ...
                                    <div class="blk pickupAndDeliveryInfo hidden">
                                        <div class="form_row row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                ...
                                                <div class="form_blk">
                                                    <select name="collection_date" id="collection_date" class="text_box selectpicker" data-container="body" onchange="fetchTimeByInterval(this.value, <?= $vendor_id ?>, 'collection_time'); appendSelectTextToId(this, 'collection-date-preview')">
                                        ...
                                        <div class="form_row row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <h6>Delivery Date</h6>
                                                <div class="form_blk">
                                                    <select name="delivery_date" id="delivery_date" class="text_box selectpicker" data-container="body" onchange="fetchTimeByInterval(this.value, <?= $vendor_id ?>, 'delivery_time'); appendSelectTextToId(this, 'delivery-date-preview')">
                                                        <option value="">Select</option>
                                                        <?= open_days_options($open_days_cd) ?>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="blk businessAddressInfo">
                                        ...
                                        <div class="form_row row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form_blk">
                                                    <select name="delivery_date" id="delivery_date" class="text_box selectpicker" data-container="body" onchange="fetchTime(this.value, <?= $vendor_id ?>, 'dropOff-time'); appendSelectTextToId(this, 'dropoff-date-preview')">
                                                        <option value="">Select</option>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form_blk">
                                                    <select name="delivery_time" id="dropOff-time" class="text_box selectpicker" data-container="body" onchange="appendSelectTextToId(this, 'dropoff-time-preview')">
                                                        <option value="">Select</option>
                                                        <?= $coming_day_times ?>
                                                    </select>
                                                </div>
