        ...
        <section id="orders">
            <div class="contain">
                ...
                <div class="tab-content">
                    ...
                    <div id="New" class="job_tbl tab-pane fade">
                        <table>
                            <tbody>
                    ...
                    <div id="Pending" class="job_tbl tab-pane fade">
                        <table>
                            <tbody>
                                <?php if (!empty($inprogress_orders)) { ?>
                                    <?php foreach ($inprogress_orders as $order) {
                                        $services = $order->services;
                                    ?>
                                        <tr class="<?= order_log($order->order_id) ?>">
                                            <td>
                    ...
                    <div id="Completed" class="job_tbl tab-pane fade">
                        <table>
                            <tbody>
