        ...
        <section id="orders">
            <div class="contain">
                ...
                <div class="tab-content">
                    ...
                    <div id="New" class="job_tbl tab-pane fade in">
                        <table>
                            <tbody>
                                <?php if (empty($new_orders)) : ?>
                                    <tr>
                                        <td>No new order yet.</td>
                                    </tr>
                                    <?php else : foreach ($new_orders as $key => $order) : ?>
                                        <tr class="<?= order_log($order->order_id) ?>">
                                            <td>
                                                <div class="ico_blk">
                                                    <div class="icon ico"><img src="<?= base_url('assets/images/users/2.jpg') ?>" alt=""></div>
                    ...
                    <div id="Pending" class="job_tbl tab-pane fade in">
                        <table>
                            <tbody>
                                <?php if (empty($inprogress_orders)) : ?>
                                    <tr>
                                        <td>No pending order yet.</td>
                                    </tr>
                                    <?php else : foreach ($inprogress_orders as $key => $order) : ?>
                                        <tr class="<?= order_log($order->order_id) ?>">
                                            <td>
                                                <div class="ico_blk">
                                                    <div class="icon ico"><img src="<?= base_url('assets/images/users/2.jpg') ?>" alt=""></div>
                    ...
                    <div id="Completed" class="job_tbl tab-pane fade in">
                        <table>
                            <tbody>
                                <?php if (empty($completed_orders)) : ?>
                                    ...
                                    <?php else : foreach ($completed_orders as $key => $order) : ?>
                                        <tr class="<?= order_log($order->order_id) ?>">
                                            <td>
                                                <div class="ico_blk">
                                                    <div class="icon ico"><img src="<?= base_url('assets/images/users/2.jpg') ?>" alt=""></div>
