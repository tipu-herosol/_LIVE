                        ...
                        <div class="col col2">
                            <div class="data_blk">
                                <fieldset data-name="vendor">
                                    ...
                                    <div class="blk pickupAndDeliveryInfo hidden">
                                        <div class="form_row row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                ...
                                                <div class="form_blk">
                                                    <select name="collection_date" id="collection_date" class="text_box selectpicker collection-date-end" data-container="body" onchange="fetchTimeByInterval(this.value, <?= $vendor_id ?>, 'collection_time'); appendSelectTextToId(this, 'collection-date-preview')">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                ...
                                                <div class="form_blk">
                                                    <select name="collection_time" id="collection_time" class="text_box selectpicker collection-time-end" data-container="body" onchange="appendSelectTextToId(this, 'collection-time-preview')">
                                                        <option value="">Select</option>
                                                        <!-- <?= $coming_day_times_cd ?> -->
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <h6>Collects From</h6>
                                                <div class="form_blk">
                                                    <select name="collection_from" id="collection_from" class="text_box" onchange="appendValueSelect(this, 'collection-type')">
                                                        <option value="">Select</option>
                                        ...
                                        <div class="form_row row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <h6>Delivery Date</h6>
                                                <div class="form_blk">
                                                    <select name="delivery_date" id="delivery_date" class="text_box selectpicker delivery-date-end" data-container="body" onchange="fetchTimeByInterval(this.value, <?= $vendor_id ?>, 'delivery_time'); appendSelectTextToId(this, 'delivery-date-preview')">
                                                        <option value="">Select</option>
                                                        <?= open_days_options($open_days_cd) ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <h6>Delivery Time</h6>
                                                <div class="form_blk">
                                                    <select name="delivery_time" id="delivery_time" class="text_box selectpicker delivery-time-end" data-container="body" onchange="appendSelectTextToId(this, 'delivery-time-preview')">
                                                        <option value="">Select</option>
                                                        <!-- <?= $coming_day_times_cd ?> -->
                                                    </select>
                                                </div>
                                    ...
                                    <div class="blk businessAddressInfo">
                                        ...
                                        <div class="form_row row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form_blk">
                                                    <select name="delivery_date" id="delivery_date" class="text_box selectpicker drop-off-date-end" data-container="body" onchange="fetchTime(this.value, <?= $vendor_id ?>, 'dropOff-time'); appendSelectTextToId(this, 'dropoff-date-preview')">
                                                        <option value="">Select</option>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form_blk">
                                                    <select name="delivery_time" id="dropOff-time" class="text_box selectpicker drop-off-time-end" data-container="body" onchange="appendSelectTextToId(this, 'dropoff-time-preview')">
                                                        <option value="">Select</option>
                                                        <!-- <?= $coming_day_times ?> -->
                                                    </select>
                                                </div>
                                ...
                                <fieldset data-name="address">
                                    ...
                                    <?php endif; ?>
                                    <div class="top_head">
                                        <h4 class="heading"><?= $content['step4_heading'] ?></h4>
            ...
            $(window).on("load", function() {
                ...
                $(document).on('click', '.next_btn', function() {
                    ...
                    if (check) {
                        ...
                        $('.svc_lst > li[data-name=' + field_name + ']').addClass("done");
                        // fieldset
                        ...
                        if (status == google.maps.GeocoderStatus.OK) {
                            ...
                            $.ajax({
                                ...
                                success: function(rs) {
                                    ...
                                    $('#collection-address').text(`${address_type.val()}: <br/> ${address_field.val()} <br/> ${address_city.val()} <br/> ${address_zip.val()}`);
                                    $('#delivery-address').text(`${address_type.val()}: <br/> ${address_field.val()} <br/> ${address_city.val()} <br/> ${address_zip.val()}`);
