...
<body data-page="dash">
    ...
    <main>
                                ...
                                <form action="<?= base_url() ?>vendor/complete_order" method="post" class="frmCompleteOrder">
                                    ...
                                    <div class="form_row row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="form_blk">
                                                <button type="button" class="text_box uploadImg" data-upload="bag_pic" data-text="Choose files"></button>
        ...
        <script>
            ...
            $(function() {
                $(document).on('click', '#save-notes.edit_notes', function() {
                    $(this).removeClass("edit_notes");
                    $("#customer_notes").removeAttr("readonly").focus();
                })
                $(document).on('click', '#save-notes:not(.edit_notes)', function(e) {
                    e.preventDefault();
                    var current = $(this);
                    let order_id = current.data('o-id');
                    let notes = $('#customer_notes').val();
                    $(this).addClass("edit_notes");
                    $("#customer_notes").attr("readonly", true).html(notes);
