                            ...
                            <div class="blk">
                                <div class="form_row row">
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form_blk">
                                            <input type="text" name="mem_charges_per_miles" id="mem_charges_per_miles" value="<?= $mem_data->mem_charges_per_miles ?>" class="text_box lg" placeholder="eg: £100">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                        <h6>Pick & drop off free for over (Order Amount)</h6>
                                        <div class="form_blk">
                                            <input type="text" name="mem_charges_free_over" id="mem_charges_free_over" value="<?= $mem_data->mem_charges_free_over ?>" class="text_box lg" placeholder="eg: £100">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                        <h6>Minimum order value?</h6>
                                        <div class="form_blk">
                                            <input type="text" name="mem_charges_min_order" id="mem_charges_min_order" value="<?= $mem_data->mem_charges_min_order ?>" class="text_box lg" placeholder="eg: £25">
                                        </div>
                                    </div>
