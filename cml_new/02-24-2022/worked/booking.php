                    ...
                    <div class="flex_row">
                        ...
                        <div class="col col2">
                            <div class="data_blk">
                                ...
                                <!-- <fieldset data-name="instruction" id="instruction">
                                    <div class="blk">
                                    ...
                                    <div class="blk">
                                        ...
                                        <div class="form_blk">
                                            <textarea name="" id="" class="text_box" placeholder="Please add any special washing instruction or request here..."></textarea>
                                        </div>
                                    </div>
                                    <div class="btn_blk form_btn text-center">
                                        <button type="button" class="site_btn light prev_btn"><img src="<?= base_url('assets/images/arrow-left-sm.svg') ?>" alt=""> Previous step</button>
