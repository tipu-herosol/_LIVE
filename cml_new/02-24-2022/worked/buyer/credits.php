    ...
    <main>
        ...
        <section id="credits">
            <div class="contain">
                ...
                <div class="flex_row credit_row full_height text-center">
                    <div class="col">
                        <div class="blk mini_credit_blk" style="background-image: url('<?= base_url('assets/images/logo.svg') ?>');">
                            <h4>Order# <span class="color">cml29938</span></h4>
                            <p class="size_5">
                                <strong>Order Date</strong>
                                <br>
                                <span class="gray-color">Tue, 18 Jan 2022</span>
                            </p>
                            <p class="price size_5">You Paid: <strong class="color">£<?= order_total_price($order->order_id) ?></strong></p>
                        </div>
                    </div>
                    <div class="col">
                        <div class="blk mini_credit_blk empty" style="background-image: url('<?= base_url('assets/images/logo.svg') ?>');">
                            ...
                            <p class="price size_5">&nbsp; <strong class="color">&nbsp;</strong></p>
                        </div>
                    </div>
                    <div class="col">
                        <div class="blk mini_credit_blk empty" style="background-image: url('<?= base_url('assets/images/logo.svg') ?>');">
