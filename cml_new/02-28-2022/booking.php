                                ...
                                <fieldset data-name="vendor" id="vendor">
                                    ...
                                    <div class="blk businessAddressInfo">
                                        ...
                                        <div class="form_row row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form_blk">
                                                    <select name="dropoff_time" id="dropOff-time" class="text_box selectpicker drop-off-time-end" data-container="body" onchange="appendSelectTextToId(this, 'dropoff-time-preview')">
                                                        <option value="">Select</option>
                                                        <!-- <?= $coming_day_times ?> -->
                                                    </select>
                                                </div>
                                    ...
                                    <div class="blk">
                                        ...
                                        <ul class="list flex">
                                            ...
                                            <li>
                                                ...
                                                <span id="customer-phone-bckup"><?= empty($vendor->mem_phone) ? 'n/a' : $vendor->mem_phone ?></span>
                                            </li>
                                            <li>
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <?php if(!empty($this->session->mem_id) && $buyer_credits == 9) : ?>
                                                                <div class="buyer_credit_discount alert" id="buyer-credit-discount-preview"><p>Congratulations!</p><p>Since this is your 10th order you have now <?= $site_settings->site_buyer_credit_percentage ?>% off this order</p></div>
                                                            <?php else : ?>
