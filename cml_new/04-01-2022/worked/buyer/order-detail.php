        ...
        <section id="orders">
            <div class="contain">
                <div class="btn_blk form_blk">
                    <a href="#" onclick="history.go(-1);" class="site_btn learn"><img src="<?= base_url('assets/images/arrow-left-sm.svg') ?>" alt=""> Back</a>
                </div>
                <div class="blk">
                    <div class="order_blk">
                        ...
                        <div class="txt">
                            ...
                            <ul class="list">
                                <li>
                                    ...
                                    <span><?= $vendor->mem_company_name ?></span>
                                </li>
                                <li>
                                    <strong>Phone Number:</strong>
                                    <span><?= empty($vendor->mem_phone) ? 'n/a' : $vendor->mem_phone ?></span>
                                </li>
                                <li>
                                    <strong>Email Address:</strong>
                                    <span><?= $vendor->mem_email ?></span>
                                </li>
                            </ul>
                            <hr>
                            <ul class="list">
                                ...
                                <?php if (!empty($order->extra_address_detail)) : ?>
                                    <li>
                                        <strong>Additional address information:</strong>
                                        <span><?= $order->extra_address_detail ?></span>
                                    </li>
                                <?php endif; ?>
                                <li>
                                    <strong>Instructions for vendor:</strong>
                                    <span id=""><?= empty($order->note_for_vendor) ? 'n/a' : $order->note_for_vendor ?></span>
                                </li>
                                <li>
                        ...
                        <table>
                            ...
                            <tbody class="foot_rows">
                                <?php if ($order->pick_and_drop_service == '1') : ?>
                                    ...
                                    <?php if ($order->minimum_order_price > 0) : ?>
                                        <tr>
                                            <td colspan="4" class="color text-right">Minimum Order:</td>
                                            <td class="color text-center">£<?= price_format($order->vendor_minimum_order) ?></td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="table_cell">
                        <div class="contain">
                            <div class="_inner">
                                ...
                                <h4>Are you sure you want to reject it? </h4>
                                <form action="<?= base_url('buyer/reject_proof_delivery/'); ?>" method="post" id="rejectDeliveryAndRating" class="rejectDeliveryAndRating">
                                    ...
                                    <textarea name="proof_reject_reason" id="proof_reject_reason" class="text_box" placeholder="Write a little description"></textarea>
                                    <br />
                                ...
                                <div class="review_row flex_row">
                                    <div class="col col1">
                                        <div class="in_col text-center">
                                            <div class="ico" data-fancybox="review" href="<?= get_site_image_src("members", get_mem_image($order->vendor_id)) ?>">
                                                <img src="<?= get_site_image_src("members", get_mem_image($order->vendor_id)) ?>" alt="">
                                            </div>
                                            <h4 class="color"><?= get_mem_com_name($order->vendor_id) ?></h4>
                                        </div>
                                    </div>
                                    <div class="col col2">
                                        <div class="in_col">
                                            <form action="<?= base_url() ?>buyer/accept_proof_delivery" method="post" id="acceptDeliveryAndRating" class="acceptDeliveryAndRating">
                                                ...
                                                <div class="form_blk">
                                                    ...
                                                    <div class="rating bg">
                                                        ...
                                                        <strong>
                                                            <spna class="review-rating-selection">1</spna>/5 Stars
                                                        </strong>
                                                    </div>
                                                </div>
                                                <div class="form_blk">
                ...
                <div class="table_dv">
                    <div class="table_cell">
                        <div class="contain">
                            <div class="_inner">
                                <div class="cross_btn"></div>
                                <h3>Pay Amended Amount <span class="color" id="amnded-invoice-to-pay"></span></h3>
            ...
            <div class="popup" data-popup="refund">
                <div class="table_dv">
                    <div class="table_cell">
                        <div class="contain">
                            <div class="_inner">
                                <div class="cross_btn"></div>
                                <h3>Cancel order <strong class="color">#cml00089</strong></h3>
                                <form action="" method="post">
                                    <div class="form_blk">
                                        <div class="lbl_btn">
                                            <input type="checkbox" name="paymthd" id="paymthd">
                                            <label for="paymthd">Refund £32.90 back into my original Payment Method</label>
                                        </div>
                                    </div>
                                    <div class="form_blk">
                                        <div class="lbl_btn">
                                            <input type="checkbox" name="paycrdt" id="paycrdt">
                                            <label for="paycrdt">Refund £32.90 as a form of credit</label>
                                        </div>
                                    </div>
                                    <p class="small"><span class="red-color">Note:</span> A refund of your order back into your original payment method may take 3-5 days depending on your bank and you'll incur a cancellation charge of £5.</p>
                                    <p class="small">A refund of your order as a form of credit to use towards your next order straight away.</p>
                                    <div class="btn_blk text-center">
                                        <button type="submit" class="site_btn long">Continue</button>
                                        <button type="reset" class="site_btn light long">Cancel</button>
                                    </div>
                                </form>
                            </div>
                        </div>
