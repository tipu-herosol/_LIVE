                ...
                <?php if (!empty($promos)) { ?>
                    ...
                    <div class="flex_row full_height filter_promos">
                        ...
                        foreach ($promos as $promo) { ?>
                            <div class="col">
                                <div class="promo_blk">
                                    <div class="bnr" style="background-image: url('<?= base_url('assets/images/b_01.jpg') ?>');">
                                    ...
                                    <div class="txt">
                                        ...
                                        <!-- <p><?= $promo->tagline ?></p> -->
                                        <div class="btn_blk form_btn form_blk"><a href="<?= base_url() ?>" class="site_btn md block">Order Now</a></div>
                                        <p>This offer expires on <span class="red-color"><?= $promo->expiry_date ?></span> <br> <?= $promo->tagline ?></p>
                                    </div>
                                    <div class="btm">
