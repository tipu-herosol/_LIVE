                                            ...
                                            <tbody id="selected_services">
                                                ...
                                                <?php if($buyer_credits !== 9): ?>
                                                    <tr id="promo-code-section">
                                                        <td colspan="3">
                                                            <span>Apply Discount Or Referral Code</span>
                                                            <input class="text_box" type="text" id="promo_code" name="promo_code" placeholder="Code eg: CMLWASH10" /> 
            ...
            $.ajax({
                ...
                success: function(rs) {
                    if(rs.status)
                    {
                        ...
                        $('#promo-code-result').css({'color': 'green'});
                        calculateEstimatedAmount();
                    }
                    else
                    {
                        ...
                        $('#promo-code-result').css({'color': 'red'});
                        calculateEstimatedAmount();
                    }
                },
                complete: function() {
