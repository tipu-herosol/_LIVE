                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="lblBtn">
                                                                ...
                                                                <label for="WashDry<?= $key ?>"><?= $sub_service->name ?></label>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <div class="form_blk ico_form_blk">
                                                                ...
                                                                <input type="text" name="sub_service[<?= $sub_service->id ?>][price]" class="text_box auto-price-format" <?= count($price) > 0 ? 'value="' . $price->price . '"' : 'placeholder="0.00"' ?>>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="lblBtn">
                                                                ...
                                                                <label for="DryCleaning<?= $key ?>"><?= $sub_service->name ?></label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="lblBtn">
                                                                ...
                                                                <label for="WashIron<?= $key ?>"><?= $sub_service->name ?></label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="lblBtn">
                                                                ...
                                                                <label for="IronOnly<?= $key ?>"><?= $sub_service->name ?></label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="lblBtn">
                                                                ...
                                                                <label for="BulkyItems<?= $key ?>"><?= $sub_service->name ?></label>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="lblBtn">
                                                                ...
                                                                <label for="Deals<?= $key ?>"><?= $sub_service->name ?></label>
...
<script type="text/javascript">
    $(document).on('change', '.auto-price-format', function() {
