    ...
    <div class="contain">
        <div class="flex_row">
            <div class="col">
                ...
                <form action="<?= base_url('newsletter') ?>" method="post" autocomplete="off" class="frmAjax" id="newsletterFrm" data-form="newsletter">
            ...
            <div class="col">
                ...
                <p>Coming Soon</p>
                <ul class="playStore">
                    <li><a><img src="<?= base_url('assets/images/google-play-store.svg') ?>" alt=""></a></li>
                    <li><a><img src="<?= base_url('assets/images/apple-app-store.svg') ?>" alt=""></a></li>
                </ul>
            </div>
        </div>
