                            ...
                            <div class="_inner">
                                ...
                                <form action="<?= base_url() ?>vendor/amend_invoice" method="post" id="frmAmendInvoice" class="frmAmendInvoice">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form_row row">
                                                ...
                                                <div class="col-xs-4">
                                                    <h6>Item <sup>*</sup></h6>
                                                    <div class="form_blk">
                                                        <input type="text" name="" id="" class="text_box" placeholder="eg: Lorem Ipsum">
                                                    </div>
                                                </div>
                                                <div class="col-xs-2">
                                                    <h6>Quantity <sup>*</sup></h6>
                                                    <div class="form_blk">
                                                        <input type="text" name="quantity" id="quantity" class="text_box" placeholder="eg: 20">
                                                    </div>
                                                </div>
                                                <div class="col-xs-2">
                                                    <h6>Unit Price <sup>*</sup></h6>
                                    ...
                                    <div class="btn_blk mt text-right">
                                        <button type="button" class="site_btn text">Add new</button>
                                    </div>
                                    <div class="br"></div>
                                    <div class="form_row row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="form_blk">
                                                <textarea name="" id="" class="text_box" placeholder="Type something here"></textarea>
                                            </div>
                                        </div>
                                    </div>
