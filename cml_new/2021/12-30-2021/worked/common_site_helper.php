    ...
    if (!empty($amended_records)) :
        $html .= '
            <tr class="amend_row">
                ...
                <th class="text-center"><span class="badge yellow">Dummy</span></th>
            </tr>
            <tr>
                <th>Services</th>
        ...
        foreach ($amended_records as $key => $row) :
            ...
            $html .= '<tr>
                    ...
                    <td class="text-center"><span class="badge ' . amend_item_pay_status(check_amend_item_pay_status($row->order_id, $row->id)) . '">' . check_amend_item_pay_status($row->order_id, $row->id) . '</span></td>
