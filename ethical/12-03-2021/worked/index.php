            ...
            <div class="contain">
                ...
                <div class="content text-center">
                    ...
                    <form action="<?= site_url() ?>search" method="get" class="srchBar" autocomplete="off">
                        <div class="txtGrp dropDown srchGrp">
                            ...
                            <img src="<?= base_url() ?>assets/images/icon-eco.svg" alt="">
                            <ul class="dropCnt dropLst" id="brand_suggesstions">
                            </ul>
                        </div>
                        <div class="txtGrp ctryGrp">
                        ...
                        <div class="txtGrp catgGrp srchCat">
                            <!-- <label for="country" class="move">Category</label> -->
                            <select name="category[]" class="txtBox catSelectpicker" data-live-search="true" data-container="body" multiple>
                        ...
                        <div class="bTn">
                            <button type="submit" class="webBtn icoBtn"><img src="<?= base_url() ?>assets/images/icon-search.svg" alt=""></button>
                        </div>
                    </form>
                </div>
            </div>
