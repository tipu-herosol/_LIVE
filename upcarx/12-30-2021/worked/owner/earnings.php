<main>
    ...
    <section id="trans">
        <div class="contain">
            ...
            <div class="br"></div>
            <div class="top_head">
                <h4 class="heading">Wallet summary</h4>
                <div class="btn_blk">
                    <button type="button" class="site_btn sm pop_btn" data-popup="withdraw-amount">Withdrawal</button>
                </div>
            </div>
            <div class="blk">
                <div class="tbl_blk">
                    <table>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="alert danger-alert cmn-alert"><span><i class="fi-cross"></i></span><em>No record(s) found yet!</em></div>
                                    </td>
                                </tr>
                            <?php
                            }
        ...
        <div class="popup sm" data-popup="withdraw-amount">
            <div class="table_dv">
                <div class="table_cell">
                    <div class="contain">
                        <div class="_inner">
